...
import { MeshBasicMaterial, Vector2, TextureLoader } from "three";
...
// 计算对应UV坐标
export function computeUV(geometry) {
...
export const blackBasicMaterial = new MeshBasicMaterial({ color: "black" });
export const textureLoader = new TextureLoader();
export const BASE_PATH = `./static/three.js`