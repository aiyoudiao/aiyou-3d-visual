...
export default class ThreeHandle {
    ...
    __generateCube (obj) {
        ...
        var skin_opacity = 1;
        const { skin } = obj.style || undefined
        ...
        if (skin) {
            ...
            console.log('skin_right', 'obj.style.skin.skin_right', '相等吗？')
            console.log(skin_right, obj.style.skin.skin_right, skin_right === obj.style.skin.skin_right)

            console.log('skin_left', 'obj.style.skin.skin_left', '相等吗？')
            console.log(skin_left, obj.style.skin.skin_left, skin_left === obj.style.skin.skin_left)

            console.log('skin_up', 'obj.style.skin.skin_up', '相等吗？')
            console.log(skin_up, obj.style.skin.skin_up, skin_up === obj.style.skin.skin_up)

            console.log('skin_down', 'obj.style.skin.skin_down', '相等吗？')
            console.log(skin_down, obj.style.skin.skin_down, skin_down === obj.style.skin.skin_down)

            console.log('skin_fore', 'obj.style.skin.skin_fore', '相等吗？')
            console.log(skin_fore, obj.style.skin.skin_fore, skin_fore === obj.style.skin.skin_fore)

            console.log('skin_down', 'obj.style.skin.skin_down', '相等吗？')
            console.log(skin_down, obj.style.skin.skin_down, skin_down === obj.style.skin.skin_down)
            //右
            skin_right_obj = this.__generateSkinOption(depth, height, obj.style.skin.skin_right, cubeGeometry,skin_right_handle_end, 0);
            //左
            skin_left_obj = this.__generateSkinOption(depth, height, obj.style.skin.skin_left, cubeGeometry,skin_left_handle_end, 2);
            //上
            skin_up_obj = this.__generateSkinOption(width, depth, obj.style.skin.skin_up, cubeGeometry,skin_up_handle_end, 4);
            //下
            skin_down_obj = this.__generateSkinOption(width, depth, obj.style.skin.skin_down, cubeGeometry,skin_down_handle_end, 6);
            //前
            skin_fore_obj = this.__generateSkinOption(width, height, obj.style.skin.skin_fore, cubeGeometry,skin_fore_handle_end, 8);
            //后
            skin_behind_obj = this.__generateSkinOption(width, height, obj.style.skin.skin_behind, cubeGeometry,skin_behind_handle_end, 10);
        ...
        cubeMaterialArray.push(new THREE.MeshLambertMaterial(skin_right_obj as any));
        cubeMaterialArray.push(new THREE.MeshLambertMaterial(skin_left_obj as any));
        cubeMaterialArray.push(new THREE.MeshLambertMaterial(skin_up_obj as any));
        cubeMaterialArray.push(new THREE.MeshLambertMaterial(skin_down_obj as any));
        cubeMaterialArray.push(new THREE.MeshLambertMaterial(skin_fore_obj as any));
        cubeMaterialArray.push(new THREE.MeshLambertMaterial(skin_behind_obj as any));
