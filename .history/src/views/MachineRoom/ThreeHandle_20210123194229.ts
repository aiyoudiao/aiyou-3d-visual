...
export default class ThreeHandle {
    ...
    constructor(ThreeSet) {
        const {
            props, dataSet, eventList, sourcePath = './static/three.js/', dataJson
        } = ThreeSet
    ...
    __generateEmptyCabinet(item: any) {
        ...
        if (![null, undefined].includes(childrens) && Array.isArray(childrens)) {
            ...
            childrens.forEach((service, index) => {
                ...
                newObj.data['equipmentUUID'] = uuid
     ...
     * @date 2021-01-23
     * @param {any} rotation:any
     * @param {any} cubeObj:THREE.Object3D
     * @returns {any}
     */    
    __handleRotaion(rotation: any, cubeObj: THREE.Object3D) {
