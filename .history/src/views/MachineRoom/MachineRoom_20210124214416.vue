<template>
  <div class="machine-room">
    ...
    <div id="three-app-dom">
      <div v-cloak="" id="tan" style="width:300px;height:400px;" ref="tan" :style="{left:left + 'px',top:top + 'px'}"
        v-show="bool">
        <div style="position:relative;">
          <div style="position: absolute;left: 0px;top: 0px;">
            <img :src="require('@/assets/picture/2.png')" alt="" style="width:400px;opacity: 1.0;">
          </div>
