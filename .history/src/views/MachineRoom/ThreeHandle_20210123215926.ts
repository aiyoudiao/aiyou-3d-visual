...
export default class ThreeHandle {
    ...
    __generateEmptyCabinet(item: { uuid?: any; size?: any; style?: any; name?: any; data?: any; doors?: any; rotation?: any; x?: any; y?: any; z?: any; width?: any; height?: any; childrens?: any }) {
        ...
        tempObj.uuid = uuid
        tempObj.data = item.data || { name: item.name, alarmInfo: [] }
        ...
        if (![null, undefined].includes(item.data)) {
            const { width: textAreaWidth = 70, height: textAreaHeight = 70, data: data } = item
            const canvas = document.createElement('canvas')
            ...
            marker(context, textAreaWidth / 2, textAreaHeight / 2, data.name)
            ...
            sprite.data = { "cabinetUUID": uuid, "level": "1", alarmInfo: [] } /* 告警等级默认为1，也就是最低告警 */
