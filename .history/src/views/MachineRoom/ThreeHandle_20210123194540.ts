...
export default class ThreeHandle {
    ...
    constructor(ThreeSet: { props: any; dataSet: any; eventList: any; sourcePath?: "./static/three.js/"; dataJson: any }) {
        const {
    ...
    __mergeModel(mergeOp: any, firstObj: THREE.Mesh<THREE.BoxGeometry, any[]> | THREE.Object3D, secondObj: THREE.Mesh<THREE.BoxGeometry, any[]>, commonSkin?: any): THREE.Mesh<THREE.BoxGeometry, any[]> | THREE.Object3D{
