...
export default class ThreeHandle {
    ...
    constructor(ThreeSet: { props: any; dataSet: any; eventList: any; sourcePath?: "./static/three.js/images/"; dataJson: any, vueModel: Vue}) {
        const {
    ...
    onDocumentMouseMove(event) {
        ...
        if (intersects.length > 0) {
            ...
            if (SELECTED.name.toString().includes('cabinet')) {
                ...
                this.vueModel.$data.currentMesh.name = new Date().toLocaleString()
