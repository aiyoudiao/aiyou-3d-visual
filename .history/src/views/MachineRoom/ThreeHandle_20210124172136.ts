...
export default class ThreeHandle {
     ...
     * @Description 生成 模型对象
     * @date 2021-01-24
     * @param {any} item:{childrens:any[];objHandle:any}
     * @returns {any}
     */    
    __generateObjPlant(item: { childrens: any[]; objHandle: any }) {
        ...
        mtlLoader.load(this.BASE_PATH + ('plant/plant.mtl'), (materials) => {
            ...
            objLoader.load(this.BASE_PATH + ('plant/plant.obj'), (object: any) => {
                item.childrens.forEach((childobj: { objHandle: any; x: any; y: any; z: any }) => {
                    ...
                    newobj = this.__handleObj(newobj);
    ...
    __handleObj(obj: { objHandle: any[]; scale: { x: any; y: any; z: any; set: (arg0: any, arg1: any, arg2: any) => void }; rotateX: (arg0: any) => void; rotateY: (arg0: any) => void; rotateZ: (arg0: any) => void; rotateOnAxis: (arg0: THREE.Vector3, arg1: any) => void }) {
        if (obj.objHandle != null && typeof (obj.objHandle) != 'undefined' && obj.objHandle.length > 0) {
            obj.objHandle.forEach(function (childobj: { direction: any; ratio: any; degree: any; handleScale: string | any[]; handleRotale: string | any[] }) {
    ...
    //进度通知
    onProgress(xhr: { lengthComputable: any; loaded: number; total: number }) {
