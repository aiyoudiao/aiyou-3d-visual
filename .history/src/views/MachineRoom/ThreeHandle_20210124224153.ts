    ...
    onDocumentMouseMove(event) {
        ...
        if (intersects.length > 0) {
            ...
            if (SELECTED.name.toString().includes('cabinet')) {
                ...
                this.vueModel.currentMesh.left = (_this.lastEvent.pageX - 300 / 2);
                this.vueModel.currentMesh.top =  (_this.lastEvent.pageY - 400 - 15);
                this.vueModel.currentMesh.name = new Date().toLocaleString()
                this.vueModel.bool = true

                this.scene.updateMatrixWorld(true)
            } else {
                this.outlinePass.selectedObjects = []
                this.vueModel.bool = false
            }
        }
