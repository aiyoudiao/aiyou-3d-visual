...
export default class ThreeHandle {
     ...
     * @returns {any}
     */
    __mergeModel(mergeOp: any, fobj: THREE.Mesh<THREE.BoxGeometry, any[]>, sobj: THREE.Mesh<THREE.BoxGeometry, any[]>, commonSkin: any): THREE.Mesh<THREE.BoxGeometry, any[]> {
        const { ThreeBSP } = window
        const fobjBSP = new ThreeBSP()
    }
