...
export default class ThreeHandle {
     ...
     * @returns {any}
     */    
    __generateSkinOption(depth: any, height: any, skin_obj: any, cubeGeometry: THREE.BoxGeometry, skin_right_handle_end: any, cubeFaceNumber: number): any {
        /**
         * 为 null、undefined
         * 类型为 数组，不为 object
         */
        ...
        if ([null, undefined].includes(imgurl)) {
            ...
            cubeGeometry.faces[cubeFaceNumber]
