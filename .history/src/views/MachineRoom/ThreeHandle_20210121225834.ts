...
export default class ThreeHandle {
     ...
     * @param obj 
     */
    __createPlaneGeometry(obj: { width: any; height: any; imgUrl: HTMLCanvasElement; y: number; transparent: boolean; opacity: number; rotation: { direction: string; degree: number }[] }) {
