...
export default class ThreeHandle {
     ...
     * @date 2021-01-23
     * @param {any} item:{uuid?:any;size?:any;style?:any;name?:any;data?:any;doors?:any;rotation?:any;x?:any;y?:any;z?:any;width?:any;height?:any;childrens?:any}
     * @returns {any}
     */    
    __generateEmptyCabinet(item: { uuid?: any; size?: any; style?: any; name?: any; data?: any; doors?: any; rotation?: any; x?: any; y?: any; z?: any; width?: any; height?: any; childrens?: any }) {
    ...
    __mergeModel(mergeOp: any, firstObj: any, secondObj: THREE.Mesh<THREE.BoxGeometry, any[]>, commonSkin?: any): any {
        ...
        const result = resultObjBSP.toMesh(cubeMaterialArray)
        ...
        resultFaces.forEach((resultFaceItem: { vertexNormals: any[]; color: { setHex: (arg0: any) => void }; materialIndex: number }, resultFaceIndex: any) => {
            ...
            firstObjFace.forEach((firstFaceItem: { vertexNormals: { [x: string]: { z: any } }; materialIndex: any }, firstFaceIndex: any) => {
