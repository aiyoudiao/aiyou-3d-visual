...
export default class ThreeHandle {
    ...
    __generateCube(item: any) {
        ...
        if (skin) {
            ...
            const [skin_right_handle_end, skin_left_end, skin_up_end, skin_down_end, skin_fore_end, skin_behind_end] = middleData

            skin_right_obj = this.__generateSkinOption(depth, height, skin_right, cubeGeometry, skin_right_handle_end)
            skin_left_obj = this.__generateSkinOption(depth, height, skin_left, cubeGeometry, skin_left_end)
            skin_up_obj = this.__generateSkinOption(depth, height, skin_up, cubeGeometry, skin_up_end)
            skin_down_obj = this.__generateSkinOption(depth, height, skin_down, cubeGeometry, skin_down_end)
            skin_fore_obj = this.__generateSkinOption(depth, height, skin_fore, cubeGeometry, skin_fore_end)
            skin_behind_obj = this.__generateSkinOption(depth, height, skin_behind, cubeGeometry, skin_behind_end)
     ...
     * @param {any} skin_right_handle_end:any
     * @returns {any}
     */    
    __generateSkinOption(depth: any, height: any, skin_obj: any, cubeGeometry: THREE.BoxGeometry, skin_right_handle_end: any): any {
        /**
         * 非 null、undefined
         * 非 数组
         * 类型为 object
