...
export default class ThreeHandle {
    ...
    __generateCube(item: { width?: any; height?: any; depth?: any; rotation?: any; x?: any; y?: any; z?: any; uuid?: any; name?: any; style?: any; objType?: any }): any {
        ...
        cubeMaterialArray[2] = new THREE.MeshBasicMaterial({"color":"","map":{"metadata":{"version":4.5,"type":"Texture","generator":"Texture.toJSON"},"uuid":"6ECAC2FE-BA2C-483A-B673-193FA9ECA550","name":"","mapping":300,"repeat":[15.625,12.5],"offset":[0,0],"center":[0,0],"rotation":0,"wrap":[1000,1000],"format":1023,"type":1009,"encoding":3000,"minFilter":1008,"magFilter":1006,"anisotropy":1,"flipY":true,"premultiplyAlpha":false,"unpackAlignment":4},"opacity":1})
